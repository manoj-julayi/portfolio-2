! function(e, t) {
    ...
    function o(e, t) {
        if ((C(e) || e === window || e === document) && (e = [e]), A(e) || L(e) || (e = [e]), 0 != P(e))
            if (A(e) && !L(e))
    ...
    function S(e, t, i) {
        ...
        else if (T(t) && (i = t, t = !1), k(t) && t in window) T(i) && i();
        else {
            var n;
            if (-1 !== e.indexOf(".css")) {
    ...
    var _ = function() {
        function e(i, n) {
            ...
            var s = function() {};
            this.rotate = D(this.element, n.rotate || s), this.touchStart = D(this.element, n.touchStart || s), this.multipointStart = D(this.element, n.multipointStart || s), this.multipointEnd = D(this.element, n.multipointEnd || s), this.pinch = D(this.element, n.pinch || s), this.swipe = D(this.element, n.swipe || s), this.tap = D(this.element, n.tap || s), this.doubleTap = D(this.element, n.doubleTap || s), this.longTap = D(this.element, n.longTap || s), this.singleTap = D(this.element, n.singleTap || s), this.pressMove = D(this.element, n.pressMove || s), this.twoFingerPressMove = D(this.element, n.twoFingerPressMove || s), this.touchMove = D(this.element, n.touchMove || s), this.touchEnd = D(this.element, n.touchEnd || s), this.touchCancel = D(this.element, n.touchCancel || s), this._cancelAllHandler = this.cancelAll.bind(this), window.addEventListener("scroll", this._cancelAllHandler), this.delta = null, this.last = null, this.now = null, this.tapTimeout = null, this.singleTapTimeout = null, this.longTapTimeout = null, this.swipeTimeout = null, this.x1 = this.x2 = this.y1 = this.y2 = null, this.preTapPosition = {
                x: null,
                y: null
            }
        }
    ...
    function B(e) {
        var t = function() {
            ...
            i = c(e, "gslide-media") ? e : e.querySelector(".gslide-media"),
            n = e.querySelector(".gslide-description");
        h(i, "greset"), v(i, "translate3d(0, 0, 0)"), a(t, {
            onElement: i,
            once: !0,
            withCallback: function(e, t) {
                d(i, "greset")
    ...
    function W(e) {
        ...
        var t, i, n, s = y(),
            ...
            q = new _(z, {
                ...
                touchEnd: function() {
                    if (r) {
                        if (p = !1, S || b) return k = w, void(C = T);
                ...
                pinch: function(e) {
                    ...
                    var t = m * e.zoom;
                    if (S = !0, t <= 1) return S = !1, t = 1, C = null, k = null, w = null, T = null, void f.setAttribute("style", "");
    ...
    function F(e, t, i, n) {
        ...
        "file" == u && (u = "http"), r.style.maxWidth = t.width, S(this.settings.plyr.js, "Plyr", (function() {
            ...
            var k = O(s.settings.plyr, "config") ? s.settings.plyr.config : {},
                C = new Plyr("#" + o, k);
            C.on("ready", (function(e) {
                ...
                s.resize(e)
            })), C.on("enterfullscreen", R), C.on("exitfullscreen", R)
        }))
    }
    ...
    function G(e, t, i, n) {
        ...
        if (d && (k(d) && (s = m('<div class="ginlined-content">'.concat(d, "</div>"))), C(d))) {
    ...
    var $ = function() {
            ...
            return n(e, [{
                ...
                value: function(e, t) {
                    ...
                    return e.width = O(e, "width") && "" !== e.width ? this.checkSize(e.width) : i, e.height = O(e, "height") && "" !== e.height ? this.checkSize(e.height) : n, e
                }
            }, {
                key: "checkSize",
                value: function(e) {
        ...
        te = function() {
            function e() {
                var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                t(this, e), this.settings = l(ee, i), this.effectsClasses = this.getAnimationClasses(), this.videoPlayers = {}, this.apiEvents = [], this.fullElementsList = !1
            }
            return n(e, [{
                key: "init",
                value: function() {
                ...
                value: function() {
                    ...
                    this.slidePlayerPause(e), this.trigger("slide_before_change", {
                        ...
                        t.style.transform = "", d(t, "greset"), t.style.opacity = "", i && (i.style.opacity = ""), d(e, "prev")
                    }))
                }
            }, {
                key: "getAllPlayers",
                    ...
                    if ((e = e || this.activeSlide) && !c(e, "zoomed")) {
                        ...
                        if (l <= 768 ? h(document.body, "glightbox-mobile") : d(document.body, "glightbox-mobile"), i || n) {
                            ...
                            if (s && (c(s, "description-bottom") || c(s, "description-top")) && !c(s, "gabsolute") && (r = !0), n)
                                ...
                                g.setAttribute("style", "max-height: calc(100vh - ".concat(u, "px)")), s.setAttribute("style", "max-width: ".concat(g.offsetWidth, "px;"))
                            }
                            if (i) {
                                var v = O(this.settings.plyr.config, "ratio") ? this.settings.plyr.config.ratio : "";
                                if (!v) {
                                    var f = i.clientWidth,
                                        p = i.clientHeight,
                                        m = f / p;
                                    v = "".concat(f / m, ":").concat(p / m)
                                }
                                var x = v.split(":"),
                                    b = this.settings.videosWidth,
                                    S = this.settings.videosWidth,
                                    w = (S = M(b) || -1 !== b.indexOf("px") ? parseInt(b) : -1 !== b.indexOf("vw") ? l * parseInt(b) / 100 : -1 !== b.indexOf("vh") ? o * parseInt(b) / 100 : -1 !== b.indexOf("%") ? l * parseInt(b) / 100 : parseInt(i.clientWidth)) / (parseInt(x[0]) / parseInt(x[1]));
                                if (w = Math.floor(w), r && (o -= s.offsetHeight), S > l || w > o || o < w && l > S) {
                                    var T = i.offsetWidth,
                                        k = i.offsetHeight,
                                        C = o / k,
                                        E = {
                                    ...
                                    i.parentNode.setAttribute("style", "max-width: ".concat(E.width, "px")), r && s.setAttribute("style", "max-width: ".concat(E.width, "px;"))
                                } else i.parentNode.style.maxWidth = "".concat(S), r && s.setAttribute("style", "max-width: ".concat(S, ";"))
                            }
                        }
                    }
                }
